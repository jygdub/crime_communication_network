...
if __name__ == "__main__":
    ...
    plt.savefig(f"images/preliminary-parallel-convergence.png", bbox_inches='tight')
    ...
    plt.savefig(f"images/preliminary-parallel-mean-convergence.png",bbox_inches='tight')