...
plt.title('Global efficiency against µ-parameter')
plt.legend(bbox_to_anchor=(1,1))
plt.tight_layout()
...
plt.title('Local efficiency against µ-parameter')
plt.legend(bbox_to_anchor=(1,1))
plt.tight_layout()
...
plt.xlabel(fr'$\langle k \rangle$')
plt.ylabel('Global efficiency')
plt.title('Global efficiency against average degree-parameter')
plt.legend(bbox_to_anchor=(1,1))
plt.tight_layout()
...
plt.xlabel(fr'$\langle k \rangle$')
plt.ylabel('Local efficiency')
plt.title('Local efficiency against average degree-parameter')
plt.legend(bbox_to_anchor=(1,1))
plt.tight_layout()
