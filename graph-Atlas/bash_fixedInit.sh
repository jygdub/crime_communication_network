...
cp $HOME/Graph-Atlas/run_fixedInit_dynamics_parallel.py /scratch-shared/Graph-Atlas
cp $HOME/Graph-Atlas/fixedInit_dynamics_vectorized.py /scratch-shared/Graph-Atlas
...
python3 run_fixedInit_dynamics_parallel.py # run script